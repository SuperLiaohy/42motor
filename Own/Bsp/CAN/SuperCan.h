...
public:
    ...
    void write(uint16_t data1, uint16_t data2, uint16_t data3, uint16_t data4);
...
inline void SuperCan::write(uint16_t data1, uint16_t data2, uint16_t data3, uint16_t data4) {
